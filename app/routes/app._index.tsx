...
export default function HomePage() {
  ...
  const fetchSettings = async () => {
    ...
    try {
      const response = await fetch(`https://membi-back-production.up.railway.app/tenant/tenant_shopify_info/get_shopify_membi_setting?shop=${shop}`, {
        method: 'GET',
        headers: {
  ...
  const handleConnect = async () => {
    ...
    try {
      const response = await fetch('https://membi-back-production.up.railway.app/tenant/tenant_shopify_info/shopify_membi_connection', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      const response = await fetch('https://membi-back-production.up.railway.app/tenant/tenant_shopify_info/shopify_membi_function_setting', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
