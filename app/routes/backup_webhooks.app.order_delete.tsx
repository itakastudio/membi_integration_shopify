...
//   console.log("Received order_delete webhook");
...
//     console.log(`Received order_delete webhook for: ${JSON.stringify(orderData, null, 2)}`);
...
//   } catch (error) {
//     await client.query("ROLLBACK");
//     console.error("Error processing order_delete webhook:", error);
